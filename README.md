...
[![Build Status](https://travis-ci.org/Kryptos-Team/stratum-pool.png?branch=master)](https://travis-ci.org/Kryptos-Team/stratum-pool)

[![NPM](https://nodei.co/npm/kryptos-stratum-pool.png?downloads=true&stars=true)](https://nodei.co/npm/kryptos-stratum-pool/)
...
```javascript
var Stratum = require('kryptos-stratum-pool');
