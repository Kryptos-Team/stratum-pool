...
let multiHashing = require('kryptos-multi-hashing');
let util = require('./util.js');

let diff1 = global.diff1 = 0x00000000ffff0000000000000000000000000000000000000000000000000000;

let algos = module.exports = global.algos = {
	sha256: {
